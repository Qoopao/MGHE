...
int main() {
    ...
    LWEPlaintext result6;
    LWEPlaintext result7;   
    ...
    LWECiphertext ct4 = cc.MGHE_Encrypt(m3, 3);
    LWECiphertext ct5 = cc.MGHE_Encrypt(m4, 4);
    LWECiphertext ct6 = cc.MGHE_Encrypt(m5, 5);
    LWECiphertext ct7 = cc.MGHE_Encrypt(m6, 6);
    LWECiphertext ct8 = cc.MGHE_Encrypt(m7, 7);
    
    LWECiphertext ctNAND1;
    LWECiphertext ctNAND2;
    LWECiphertext ctNAND3;
    LWECiphertext ctNAND4;
    LWECiphertext ctNAND5;
    LWECiphertext ctNAND6;
    LWECiphertext ctNAND7;
    ...
    ctNAND3 = cc.MGEvalBinGate(NAND, ctNAND2, ct4, k);
    cout<<"---------第三个NAND门计算完成-------------"<<endl;
    cc.MGHE_Decrypt(sk, ctNAND3, &result3, k);
    std::cout << "Result of encrypted computation of ct1:"<<m0<<" NAND ( ct2:"<<m1<<" NAND ct3:"<<m2<<" ) NAND ct4:"<<m3<<" = " << result3 << std::endl;
    
    ctNAND4 = cc.MGEvalBinGate(NAND, ctNAND3, ct5, k);
    cout<<"---------第四个NAND门计算完成-------------"<<endl;
    cc.MGHE_Decrypt(sk, ctNAND4, &result4, k);
    std::cout << "Result of encrypted computation of ct1:"<<m0<<" NAND ( ct2:"<<m1<<" NAND ct3:"<<m2<<" ) NAND ct4:"<<m3<<" NAND ct5:"<<m4<<" = " << result4 << std::endl;
    
    ctNAND5 = cc.MGEvalBinGate(NAND, ctNAND4, ct6, k);
    cout<<"---------第五个NAND门计算完成-------------"<<endl;
    cc.MGHE_Decrypt(sk, ctNAND5, &result5, k);
    std::cout << "Result of encrypted computation of ct1:"<<m0<<" NAND ( ct2:"<<m1<<" NAND ct3:"<<m2<<" ) NAND ct4:"<<m3<<" NAND ct5:"<<m4<<" NAND ct6:"<<m5<<" = " << result5 << std::endl;

    ctNAND6 = cc.MGEvalBinGate(NAND, ctNAND5, ct7, k);
    cout<<"---------第六个NAND门计算完成-------------"<<endl;
    cc.MGHE_Decrypt(sk, ctNAND6, &result6, k);
    std::cout << "Result of encrypted computation of ct1:"<<m0<<" NAND ( ct2:"<<m1<<" NAND ct3:"<<m2<<" ) NAND ct4:"<<m3<<" NAND ct5:"<<m4<<" NAND ct6:"<<m5<<" NAND ct7:"<<m6<<" = " << result6 << std::endl;

    ctNAND7 = cc.MGEvalBinGate(NAND, ctNAND6, ct8, k);
    cout<<"---------第七个NAND门计算完成-------------"<<endl;
    cc.MGHE_Decrypt(sk, ctNAND7, &result7, k);
    std::cout << "Result of encrypted computation of ct1:"<<m0<<" NAND ( ct2:"<<m1<<" NAND ct3:"<<m2<<" ) NAND ct4:"<<m3<<" NAND ct5:"<<m4<<" NAND ct6:"<<m5<<" NAND ct7:"<<m6<<" NAND ct8:"<<m7<<" = " << result7 << std::endl;
